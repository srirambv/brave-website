...
jQuery(document).ready(function(){function t(){if(0!=$(".comments").length&&""!=config.disqus_shortname&&null!=config.disqus_shortname&&void 0!=config.disqus_shortname||1==config.google_comments)if(""!=config.disqus_shortname){var t=config.disqus_shortname;!function(){var e=document.createElement("script");e.type="text/javascript",e.async=!0,e.src="//"+t+".disqus.com/embed.js",(document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0]).appendChild(e)}()}else 1==config.google_comments&&$.getScript("https://apis.google.com/js/plusone.js").done(function(t,e){gapi.comments.render("g-comments",{href:window.location,width:"760",first_party_property:"BLOGGER",view_type:"FILTERED_POSTMOD"})});$(".disqus_thread, #g-comments").show(),$(".comments .graybar").html('<i class="fa fa-comments"></i>Comments')}function e(){jQuery(".tags > a:first-of-type").each(function(t){var e=jQuery(this).text();("feature"==e||"banner"==e)&&0!=jQuery(this).next().length&&(jQuery(this).hide(),jQuery(this).next().show())}),jQuery(".tags a").each(function(t){var e=jQuery(this).text();("feature"==e||"banner"==e)&&jQuery(this).hide()})}$("pre code").each(function(t){("undefined"==typeof $(this).attr("data-language")||0==$(this).attr("data-language"))&&$(this).attr("data-language","javascript")}),1==config.highlightcode&&Rainbow.color(),$(".backtotop").click(function(){return $("html, body").animate({scrollTop:0},"slow"),!1}),$(".post").fitVids(),$(".inlinemenu > .graybar").click(function(){$(".inlinemenu > .menu").toggle()}),0==$(".pagination .largeoutline").length&&$(".pagination").hide(),0==config.show_ecko_disclaimer&&$(".copyright .ecko").hide(),$(".comments .graybar").show(),(0!=$(".comments").length&&""!=config.disqus_shortname&&null!=config.disqus_shortname&&void 0!=config.disqus_shortname||1==config.google_comments)&&$(".comments .graybar").show(),$(".comments .graybar").click(function(){t()}),1==config.autoload_comments&&t(),""!=config.analytics_id&&null!=config.analytics_id&&void 0!=config.analytics_id&&(!function(t,e,n,o,a,i,s){t.GoogleAnalyticsObject=a,t[a]=t[a]||function(){(t[a].q=t[a].q||[]).push(arguments)},t[a].l=1*new Date,i=e.createElement(n),s=e.getElementsByTagName(n)[0],i.async=1,i.src=o,s.parentNode.insertBefore(i,s)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create",config.analytics_id,"auto"),ga("send","pageview")),jQuery(".shorttoggle .toggleheader").click(function(){jQuery(this).siblings(".togglecontent").toggle()}),jQuery(".shorttabs").each(function(){jQuery(".shorttabscontent",this).hide(),jQuery(".shorttabscontent",this).first().show(),jQuery(".shorttabsheader",this).first().addClass("active")}),jQuery(".shorttabsheader").click(function(){jQuery(".shorttabscontent",jQuery(this).parent()).hide(),jQuery(".shorttabsheader.active",jQuery(this).parent()).removeClass("active"),jQuery(this).addClass("active"),jQuery(".shorttabscontent[data-id='"+jQuery(this).attr("data-id")+"']").show()}),e()});